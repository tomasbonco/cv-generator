      ...
      <div class="wrapper">
        <div class="wrapper-rs">
          <div class="container-fluid">
            <div class="row">
              <div class="col-xs-12">
                <div class="margin-top-heavy visible-xs"></div>
            ...
            <div class="row">
              <div class="col-sm-3 col-xs-12"><% for(int i = 0; i < person.getEmails().size(); i++){
                                                 out.print(person.getEmails().get(i)); %><br><% } %></div>
              <div class="col-sm-3 col-xs-12">
                <div class="margin-top visible-xs"></div><% for(int i = 0; i < person.getPhones().size(); i++){
                                                            out.print(person.getPhones().get(i)); %><br><% } %>
              </div>
